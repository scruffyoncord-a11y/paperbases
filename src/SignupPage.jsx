    ...
    <div className="min-h-screen flex relative overflow-hidden bg-[#15181e]" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="flex-1 p-8 md:p-16 flex flex-col justify-center z-20" style={{ maxWidth: '650px' }}>
        <div className="max-w-md w-full">
          <span className="text-gray-500 uppercase tracking-widest text-xs font-bold mb-4 block">Get Started</span>
          <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-white">
            Create your account<span className="text-blue-500">.</span>
          </h1>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <p className="text-gray-500 text-xs text-center pt-4">
              ...
              <a href="#" className="text-blue-500 underline underline-offset-2 hover:text-blue-400">Terms of Service</a>{' '}
              and{' '}
              <a href="#" className="text-blue-500 underline underline-offset-2 hover:text-blue-400">Privacy Policy</a>.
            </p>
          </form>
        </div>
      </div>
